...
const pkg: PackageMap = {
  ...
  cli: {
    ...
    stabilizationDate: new Date("2024-07-18"),
    stabilized: false,
    excluded: false,
  },
  collections: {
  ...
  csv: {
    ...
    stabilizationDate: new Date("2024-07-27"),
    stabilized: false,
    excluded: false,
  },
  "data-structures": {
  ...
  expect: {
    ...
    stabilizationDate: new Date("2024-07-22"),
    stabilized: false,
    excluded: false,
  },
  fmt: {
  ...
  "front-matter": {
    ...
    stabilizationDate: new Date("2024-07-24"),
    stabilized: false,
    excluded: false,
  },
  fs: {
    ...
    stabilizationDate: new Date("2024-07-20"),
    stabilized: false,
    excluded: false,
  },
  html: {
  ...
  json: {
    ...
    stabilizationDate: new Date("2024-07-21"),
    stabilized: false,
    excluded: false,
  },
  jsonc: {
  ...
  yaml: {
    ...
    stabilizationDate: new Date("2024-07-23"),
    stabilized: false,
    excluded: false,
  },
}
